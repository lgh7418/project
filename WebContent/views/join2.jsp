  ...
  <div class="join-form">
    <form class="form-horizontal">
        <table class="join-table">
            ...
            <tr><td><input type="password" class="form-control" id="inputPasswordCheck" placeholder="Password"></td></tr>
            <tr></tr>
            <tr><td><button type="submit" class="btn btn-default">회원가입</button></td></tr>
        </table>
    </form>
  </div>
</body>
